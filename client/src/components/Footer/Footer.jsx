      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <SiApacheopenoffice className="text-3xl mr-2 text-blue-400" />
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-blue-400 transition duration-300"><FaFacebook className="text-2xl" /></a>
              <a href="#" className="hover:text-blue-400 transition duration-300"><FaTwitter className="text-2xl" /></a>
              <a href="#" className="hover:text-blue-400 transition duration-300"><FaLinkedin className="text-2xl" /></a>
            </div>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <Link to="/privacy-policy" className="text-sm text-blue-400 hover:underline mr-4">Privacy Policy</Link>
            <Link to="/terms-of-service" className="text-sm text-blue-400 hover:underline">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
